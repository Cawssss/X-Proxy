...
class UI:
    ...
    def banner():
        banner = f'''
    {Fore.LIGHTBLACK_EX}discord.gg/QrawKwFk86{Style.RESET_ALL}
    \t\t\t    ██╗  ██╗     ██████╗ ██████╗  ██████╗ ██╗  ██╗██╗   ██╗
    \t\t\t    ╚██╗██╔╝     ██╔══██╗██╔══██╗██╔═══██╗╚██╗██╔╝╚██╗ ██╔╝
    \t\t\t     ╚███╔╝█████╗██████╔╝██████╔╝██║   ██║ ╚███╔╝  ╚████╔╝ 
    \t\t\t     ██╔██╗╚════╝██╔═══╝ ██╔══██╗██║   ██║ ██╔██╗   ╚██╔╝  
    \t\t\t    ██╔╝ ██╗     ██║     ██║  ██║╚██████╔╝██╔╝ ██╗   ██║   
    \t\t\t    ╚═╝  ╚═╝     ╚═╝     ╚═╝  ╚═╝ ╚═════╝ ╚═╝  ╚═╝   ╚═╝  
    \t\t\t                                            {Fore.LIGHTBLACK_EX}Protect by Caws#3383{Style.RESET_ALL}
    '''
        return banner
...
def main():
    x = UI()
    p = ProxyScrape()
    system('title X-Proxy Protect by Caws#3383 ^| AIO Proxy Tool')
    system('cls')
